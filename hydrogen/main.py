...
if __name__ == "__main__":
    ...
    if plot == False:
        ...
        store(wave_form, energy=energy,lowest_residual = lowest_residual,r=r_torch, n=n, l=l,epoch_=epoch_,time_ = time_taken)
    plot_all_paper(r_torch,model_class=NN,hidden_layers=hidden_layers)
