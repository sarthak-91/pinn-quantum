...
def plot_all_wavefunctions(r, g,model_class,hidden_layers=[10,10], plot_path=PLOT_PATH, model_path=MODEL_PATH, csv_file=CSV_FILE):
    ...
    for _, row in df.iterrows():
        ...
        plt.plot(r_np, psi, label=f"NN $\\psi_{{{n}{l}}}^2$, E={energy:.5f}, g = {g:.3f}", color='blue')
