...
class NN(torch.nn.Module):
    ...
    def forward(self, input_tensor, l = 0):
        ...
        envelope = torch.exp(-self.exponential_coeff * input_tensor) * input_tensor ** (l+1) #hbc2
        #envelope = (torch.exp(-input_tensor) * (1-torch.exp(-input_tensor))) #hbc1 
        return output_tensor * envelope 
